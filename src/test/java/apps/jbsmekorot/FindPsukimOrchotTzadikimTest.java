...
public class FindPsukimOrchotTzadikimTest {
    ...
    public void testTagsSpansLength2() {
        ...
        assertTrue(doc.getSpan(10, 11).getSortedTags().contains("jbr:text-tanach-1-2-7"));
        ...
        assertEquals(getList("jbr:text-tanach-13-10-10", "jbr:text-tanach-35-8-26"), doc.getSpan(50, 51).getSortedTags());
    ...
    public void testTagsAfterMerge() {
        ...
        assertEquals(getList("jbr:text-tanach-35-8-26"), doc.getSpan(50, 51).getSortedTags());
        ...
        assertEquals(getList("jbr:text-tanach-13-23-36", "jbr:text-tanach-5-5-23", "jbr:text-tanach-8-17-26", "jbr:text-tanach-8-17-36"), doc.getSpan(52, 53).getSortedTags());
        ...
        assertEquals(getList("jbr:text-tanach-27-100-3", "jbr:text-tanach-39-20-6", "jbr:text-tanach-6-2-11"), doc.getSpan(63, 64).getSortedTags());
